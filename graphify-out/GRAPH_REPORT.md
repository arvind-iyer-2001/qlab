...
## Corpus Check
- 81 files · ~72,611 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 470 nodes · 704 edges · 30 communities detected
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 133 edges (avg confidence: 0.77)
...
Cohesion: 0.16
Nodes (20): compute_solutions(), increment_hint_reveals(), _is_unlocked(), test_submit_without_token_returns_401(), make_mock_db_for_router(), make_problem(), make_rsa_key_pair(), make_signing_key_mock() (+12 more)
...
- **Thin community `Community 14`** (5 nodes): `handleLoadCode()`, `onKey()`, `starterCode()`, `ProblemLayout.tsx`, `ProblemLayout.tsx`
...
- **Thin community `Community 20`** (3 nodes): `useMySubmissions.ts`, `useMySubmissions()`, `useMySubmissions.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (3 nodes): `MySubmissionsTab.tsx`, `formatDate()`, `MySubmissionsTab.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `submit()` connect `Community 2` to `Community 9`, `Community 3`, `Community 1`, `Community 6`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `QLabApi` connect `Community 1` to `Community 8`?**
